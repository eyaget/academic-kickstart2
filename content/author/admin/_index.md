...
Currently, I am a Research Scientist in Cybersecurity at the [Institute for Infocomm Research (I2R), A*STAR](https://www.a-star.edu.sg/i2r) (in Singapore). Previously, I worked with Femar Consulting s.r.l (as a Software Engineer),  [Security \& Trust (ST)](https://st.fbk.eu/) unit of [Fondazione Bruno Kessler (FBK)](https://www.fbk.eu/en/) (as an Assistant Researcher in Cybersecurity), [Information Network Security Agency (INSA)](https://www.insa.gov.et/) (as a Software Developer in Cybersecurity) . 
