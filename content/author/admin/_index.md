...
Currently, I am a research scientist at the [Institute for Infocomm Research (I2R), A*STAR](https://www.a-star.edu.sg/i2r). Before joining SUTD (as a PhD student), I worked with Femar Consulting s.r.l (in Italy) as a Software Engineer. Prior to that, I worked with the [Security \& Trust (ST)](https://st.fbk.eu/) unit of [Fondazione Bruno Kessler (FBK)](https://www.fbk.eu/en/) (in Italy) as an assistant researcher in cybersecurity. Previously, I was a Software Engineer (involving in a cybersecurity project) at the [Information Network Security Agency (INSA)](https://www.insa.gov.et/) in Ethiopia. 
My research interests include privacy and security of computer systems and critical infrastructures. 
